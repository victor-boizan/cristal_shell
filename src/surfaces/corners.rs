...
impl<Message> canvas::Program<Message> for CornersState {
    ...
    fn draw(
        ...
        let bar_side_fill = canvas::Fill {
            style: iced::widget::canvas::Style::Solid(theme.clone().palette().background),
            rule: iced::widget::canvas::fill::Rule::NonZero,
        };
        let empty_side_fill = canvas::Fill {
            style: iced::widget::canvas::Style::Solid(iced::Color::BLACK),
            rule: iced::widget::canvas::fill::Rule::NonZero,
        };
