...
impl Surface for Background {
    ...
    fn get_type(&self) -> SurfaceType { self.background_type.clone() }
    fn update(&mut self, _update: Update) -> Task<Message> { println!("update");Task::none() }
